...
\author{Patrick Norton, Elijah Whitlam-Sandler \and Pranay Pingali}
...
There is also the outcome where we create computational methods based on previous theory so that 
...
This project requires background knowledge of abstract algebra, and more specifically Lie theory, which Patrick and Elijah have experience with from the Fall 2023 section of Topics in Algebra. Patrick and Elijah are also each persuing either a Math-CS interdisciplinary major, or a CS minor, which will aid them in writing code that can efficiently determine the highest weight vectors of a Lie algebra $\fg$.
